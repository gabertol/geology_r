...
ages<-read_xlsx("D:/Documentos Drive/Academicos/Aulas/Palestras/Geologia_R/geology_r/file.xlsx",sheet=1) %>% as_tibble(.,.name_repair = janitor::make_clean_names)
glimpse(ages)
```
...
aak<-ages %>% 
  ...
  dplyr::rename(Hemi_long="E/W",
         Hemi_lat="N/S") %>% 
  mutate(Peate="Paraná classification                                                                   (Peate et al., 1992)") %>%
